function selfletCreateFigureLifetime(Xdata, Ydata, sendToPlotly)
figure1 = figure;
...
% Create ylabel
ylabel('Time [m]','FontWeight','bold','FontSize',34);

%Title
title('Selflets Lifetime','FontWeight','bold','FontSize',34)
